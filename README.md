...
5. **[Bash and Scripting Tutorial for Researchers](https://github.com/CosmoStat/Tutorials/tree/bash_tutorial/blob/master/README.md)** | [![github](https://badgen.net/badge/icon/github?icon=github&label)](https://github.com/fadinammour/bash_intro/)  [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/CosmoStat/Tutorials/bash_tutorial?filepath=intro.ipynb)  
